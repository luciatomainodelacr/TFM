...
def route():
    ...
    if g.email:
        ...
        # URL Grafana Mapas
        grafana_maps     = "http://" + environ.get('GRAFANA_HOST') + ":3000/d/k5-wBv-Mz/maps?orgId=1&from=1613224870152&to=1613246470152"

        # URL Grafana Puntos de carga
        grafana_url_ptos = "http://" + environ.get('GRAFANA_HOST') + ":3000/d/2HzFXkEMk/charging-stations?orgId=1&from=1612800798795&to=1613491998795&var-Province=A%20Coru%C3%B1a&var-Province=Albacete&var-Province=Alicante&var-Province=Almer%C3%ADa&var-Province=Araba%2F%C3%81lava&var-Province=Asturias&var-Province=Badajoz&var-Province=Barcelona&var-Province=Biscay&var-Province=Burgos&var-Province=Caceres&var-Province=Cadiz&var-Province=Cantabria&var-Province=Ciudad%20Real&var-Province=Cordova&var-Province=Cuenca&var-Province=Gerona&var-Province=Gipuzkoa&var-Province=Granada&var-Province=Guadalajara&var-Province=Huesca&var-Province=Jaen&var-Province=Leon&var-Province=Lleida&var-Province=Lugo&var-Province=Madrid&var-Province=Murcia&var-Province=M%C3%A1laga&var-Province=Navarre&var-Province=Ourense&var-Province=Palencia&var-Province=Pontevedra&var-Province=Rioja&var-Province=Salamanca&var-Province=Saragossa&var-Province=Seville&var-Province=Tarragona&var-Province=Teruel&var-Province=Toledo&var-Province=Valencia&var-Province=Valladolid&var-Province=Zamora&var-Province=%C3%81vila&var-Connector=IEC62196Type2Outlet"

        # URL Grafana Puntos de carga
        grafana_cars     = "http://" + environ.get('GRAFANA_HOST') + ":3000/d/Jj9wbzEGk/electric-cars?orgId=1&from=1613224999742&to=1613246599742&var-Model=ARIYA%2063KWH&var-Model=ARIYA%20E_4ORCE%2063KWH&var-Model=CYBERTRUCK%20TRI%20MOTOR"
