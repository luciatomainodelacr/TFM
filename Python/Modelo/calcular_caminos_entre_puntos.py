...
if __name__ == "__main__":
    ...
    try:
        ...
        #La restricción de autonomía se aplica directamente en la llamada a la query
        ...
        df_distancias_merged_2 = pd.merge(df_distancias, restricciones_prim_par, on=['Origen', 'Destino'], how='outer')
